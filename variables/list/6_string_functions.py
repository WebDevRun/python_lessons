...
# При передаче в качестве аргумента текстовых строк,
# байтовых строк или байтовых массивов,
# а так же списка символов, максимальное/минимальное значение
# будет выбираться исходя из порядка следования символов,
# в таблице соответствующей кодировки.
