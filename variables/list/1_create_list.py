...
print(f'list_var_function = {list_var_function}.' +
      'Тип переменной: {str(type(list_var_function))}')
...
print(f'list_from_generator = {list_from_generator}.' +
      'Тип переменной: {str(type(list_from_generator))}')
print(f'list_from_generator_2 = {list_from_generator_2}.' +
      'Тип переменной: {str(type(list_from_generator_2))}')
...
print(f'list_var_copy = {list_var_copy}.' +
      'Тип переменной: {str(type(list_var_copy))}')
print(f'list_var_copy == list_var: {list_var_copy == list_var}')

print(f'list_var_copy2 = {list_var_copy2}.' +
      'Тип переменной: {str(type(list_var_copy2))}')
print(f'list_var_copy2 == list_var: {list_var_copy2 == list_var}')

print(f'list_var_copy3 = {list_var_copy3}.' +
      'Тип переменной: {str(type(list_var_copy3))}')
