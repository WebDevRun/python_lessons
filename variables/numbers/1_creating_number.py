...
# присвоение с операторами or, and

# Оператор or выполняет следующие действия:
...
number_or_1 = 0 or False or 12
number_or_2 = 0 or 13 or 12
number_or_3 = 11 or 13 or 12

print('Результат number_or_1 =', number_or_1)
print('Результат number_or_2 =', number_or_2)
print('Результат number_or_3 =', number_or_3)
...
number_and_1 = 1 and False and 12
number_and_2 = 0 and 13 and 12
number_and_3 = 11 and 13 and 12

print('Результат number_and_1 =', number_and_1)
print('Результат number_and_2 =', number_and_2)
print('Результат number_and_3 =', number_and_3)
