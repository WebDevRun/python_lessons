...
int_from_str **= 4
print('Результат int_from_str **= 4: ' + str(int_from_str) +
      ' Тип переменной: ' + str(type(int_from_str)))

print('num_a = ' + str(num_a))
num_a &= 76
print('Результат num_a &= 76: ' + str(num_a) +
      ' Тип переменной: ' + str(type(num_a)))

print('num_b = ' + str(num_b))
num_b &= 7
print('Результат num_b &= 7: ' + str(num_b) +
      ' Тип переменной: ' + str(type(num_b)))

print('num_b = ' + str(num_b))
num_b ^= 3
print('Результат num_b ^= 3: ' + str(num_b) +
      ' Тип переменной: ' + str(type(num_b)))

print('num_a = ' + str(num_a))
num_a >>= 2
print('Результат num_a >>= 2: ' + str(num_a) +
      ' Тип переменной: ' + str(type(num_a)))

print('num_b = ' + str(num_b))
num_b <<= 2
print('Результат num_b <<= 2: ' + str(num_b) +
      ' Тип переменной: ' + str(type(num_b)))
