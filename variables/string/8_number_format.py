...
print('X - шестнадцатеричный формат (в верхнем регистре): ',
      f'{int_number:X}')
print('e - экспоненциальная запись (e в нижнем регистре): ',
      f'{int_number:e}')
print('E - экспоненциальная запись (E в нижнем регистре): ',
      f'{int_number:E}')
print('f - отображать фиксированное количество знаков (по умолчанию = 6): ',
      f'{float_number:f}')
print('.2f - отображать два знака после запятой: ', f'{float_number:.2f}')
print('% - проценты. Умножает на 100 и добавляет % в конце: ',
      f'{float_number:%}')
print('Добавить разделитель ",": ', f'{big_number:,}')
print(f'Вещественная часть: {complex_number.real},',
      f'Мнимая часть: {complex_number.imag}')
